...
Use these blocks selectively when composing Kimi or K3 prompts.
...
Use when Kimi should act without asking routine questions.
...
Use when Kimi might otherwise guess.
