...
- If Kimi made edits, say so explicitly and list the touched files when the helper provides them.
...
- If the helper reports that setup or authentication is required, direct the user to `/kimi:setup` and do not improvise alternate auth flows.
