...
Run a Kimi review through the shared plugin runtime.
...
- `/kimi:review` is standard-review only. It does not support staged-only review, unstaged-only review, or extra focus text.
- If the user needs custom review instructions or more adversarial framing, they should use `/kimi:adversarial-review`.
